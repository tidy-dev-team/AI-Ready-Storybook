...
const CardPhoto = () => (
  ...
  >
    ...
    {/* back mountains */}
    <path
      d="M0 185 L55 105 L115 165 L175 82 L235 135 L333 95 L333 290 L0 290 Z"
      fill="#A8D5BE"
    />
    {/* front mountains */}
    <path
      d="M0 225 L75 145 L135 195 L195 132 L258 185 L333 155 L333 290 L0 290 Z"
      fill="#7EC8A0"
    />
    {/* ground */}
    <path
      d="M0 255 Q83 238 166 258 Q249 278 333 252 L333 290 L0 290 Z"
      fill="#5BA37D"
    />
    {/* house body */}
...
function Tile({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ breakInside: "avoid", marginBottom: 16 }}>{children}</div>
  );
}
      ...
      <div style={{ columns: 3, columnGap: 16 }}>
        ...
        <Tile>
          <Surface p={14} gap={12}>
            ...
            <Row gap={8}>
              <ButtonIcon
                icon={<HomeIcon size={18} color="#171717" />}
                aria-label="Home"
              />
              <ButtonIcon
                icon={<WalletIcon size={18} color="#171717" />}
                aria-label="Wallet"
              />
              <ButtonIcon
                icon={<MailIcon size={18} color="#171717" />}
                aria-label="Mail"
                state="hover"
              />
              <ButtonIcon
                icon={<HeadsetIcon size={18} color="#171717" />}
                aria-label="Support"
                state="pressed"
              />
              <ButtonIcon
                icon={<ShieldIcon size={18} color="#b0b0b0" />}
                aria-label="Shield"
                state="disabled"
              />
              <ButtonIcon
                icon={<SavingsIcon size={18} color="#171717" />}
                aria-label="Savings"
              />
            </Row>
          </Surface>
