import CJS_COMPAT_NODE_URL_edywgo7p0ir from 'node:url';
import CJS_COMPAT_NODE_PATH_edywgo7p0ir from 'node:path';
import CJS_COMPAT_NODE_MODULE_edywgo7p0ir from "node:module";

var __filename = CJS_COMPAT_NODE_URL_edywgo7p0ir.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_edywgo7p0ir.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_edywgo7p0ir.createRequire(import.meta.url);
...
var core = {
  ...
  if (reactDocgenOption === "react-docgen-typescript" && typescriptPresent && plugins.push(
    ...
    let { reactDocgen } = await import("./_node-chunks/react-docgen-AGIYNVNN.js");
    plugins.unshift(
